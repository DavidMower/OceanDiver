...
def main():
    ...
    outsideDecoMapping = {'1': environementImages['sand'],
                          '2': environementImages['coral_1'],
                          '3': environementImages['coral_2'],
                          '4': environementImages['coral_3']}
        ...
        for y in range(len(mapObj[x])):
            ...
            if mapObj[x][y] in outsideDecoMapping:
                ...
                if (x, y) in goals:
                    ...
                    mapSurf.blit(environementImages['ScubaDiver'], spaceRect)
                # Then draw the star sprite.
                mapSurf.blit(environementImages['Sand'], spaceRect)
            elif (x, y) in goals:
